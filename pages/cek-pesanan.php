    ...
    <main class="cp-main">
        <div class="container cp-container">
            ...
            <header class="cp-header">
                ...
                <p class="cp-subheading">Masukkan nomor pesanan Anda untuk memantau perkembangan pesanan secara
                    real-time.</p>
            </header>

            <section class="cp-search-section" aria-label="Form cek pesanan">
                <form id="form-cek-pesanan" method="GET" action="/pages/cek-pesanan.php" class="cp-search-form">
                    <div class="cp-search-input-wrap">
                        ...
                        <div class="cp-search-row">
                            <div class="cp-input-icon-wrap">
                                ...
                                <input type="text" id="no_pesanan" name="no" class="cp-search-input"
                                    placeholder="Contoh: WF-20250115-0001" value="<?= e($no_input) ?>" maxlength="20"
                                    autocomplete="off" spellcheck="false" aria-label="Masukkan nomor pesanan">
                            </div>
                ...
                <section class="cp-result" aria-live="polite">
                    ...
                    <div class="cp-card">
                            ...
                            <div class="cp-stepper-section">
                                <div class="order-stepper" role="list" aria-label="Tahapan pesanan">
                                    ...
                                    <?php foreach ($stepper_stages as $idx => $stage):
                                        ...
                                        $step_cls = '';
                                        if ($state === 'done')
                                            $step_cls = 'stepper-step--done';
                                        if ($state === 'active')
                                            $step_cls = 'stepper-step--active';
                                        ?>
                                        <div class="stepper-step <?= e($step_cls) ?>" role="listitem"
                            ...
                            <div class="cp-cancelled-banner" role="alert">
                                ...
                                <div>
                                    ...
                                    <p class="cp-cancelled-banner__msg">
                                        Pesanan ini telah dibatalkan. Jika Anda memiliki pertanyaan, silakan hubungi kami
                                        melalui WhatsApp.
                                    </p>
                                </div>
                            </div>
                                        ...
                                        <?php foreach ($details as $item): ?>
                                            <li class="cp-product-item">
                                                <div class="cp-product-img-wrap">
                                                    ...
                                                    <img src="<?= e($foto_path) ?>" alt="<?= e($item['nama_produk']) ?>"
                                                        class="cp-product-img" loading="lazy"
                                                ...
                                                <div class="cp-product-info">
                                                    ...
                                                    <div class="cp-product-meta">
                                                        <span
                                                            class="cp-product-price"><?= format_rupiah((int) $item['harga_satuan']) ?></span>
                        ...
                        <div class="cp-contact-cta">
                            ...
                            <a href="https://wa.me/6281234567890" class="btn btn-secondary cp-contact-btn" target="_blank"
            ...
            <?php elseif ($no_input === ''): ?>
                <section class="cp-initial-hint">
                    <div class="empty-state">
                        ...
                        <p class="empty-state__message">
                            Masukkan nomor pesanan di atas, lalu klik <strong>Cek Sekarang</strong> untuk melihat status
                            pesanan Anda.
                        </p>
                    </div>
                </section>
