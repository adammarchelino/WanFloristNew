        ...
        <div class="container">
            <div class="section__header">
                ...
                <div class="category-pills" role="list">
                        ...
                        <a href="pages/katalog.php?kategori=<?= e($cat['slug']) ?>" class="category-pill" role="listitem"
    ...
    <section class="section section--primary" aria-label="Hubungi kami">
        <div class="container text-center">
            ...
            <div class="public-cta__actions">
                <a href="pages/pemesanan.php" class="hero__btn" aria-label="Isi form pemesanan online">
                    <i class="bi bi-journal-text" aria-hidden="true"></i> Form Pemesanan
                </a>
                <a href="https://wa.me/6281234567890" class="hero__btn hero__btn--outline" target="_blank"
                    rel="noopener noreferrer" aria-label="Hubungi WanFlorist via WhatsApp">
        ...
        <div class="container">
            ...
            <div class="catalog-grid">
                ...
                <article class="card testimonial-card" aria-label="Testimoni dari Rina Kusuma">
                    <div class="testimonial-rating" aria-label="Rating: 5 bintang">
                        <span class="testimonial-stars" aria-hidden="true"><i class="bi bi-star-fill"></i><i
                                class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
